  ...
  if (portalUrl) {
    portalBlock = `
      <div class="ss-portal" style="margin-top:18px;padding-top:18px;border-top:1px solid rgba(0,0,0,.08)">
        <p style="font-size:14px;color:#4b5560;margin:0 0 12px">Next: open the <b>parent portal</b> with this same email and choose <b>Create password</b>. No email link needed.</p>
...
regForm.addEventListener("submit", async function (e) {
  ...
  // Parents create a portal password in the portal after registering.
